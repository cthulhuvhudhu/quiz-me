...
val quizTestModels = listOf(
        ...
        QuizSet(3, "Quiz 3 (ans [] usr 1)", "Test quiz no answer unsolved", emptyList(), UserTestModels.users[0].entityOut),
)

val completedQuizzes = setOf(
    UserTestModels.users[0].entityOut to quizTestModels[0].entityOut,
    UserTestModels.users[0].entityOut to quizTestModels[0].entityOut,
    UserTestModels.users[1].entityOut to quizTestModels[0].entityOut,
    UserTestModels.users[1].entityOut to quizTestModels[1].entityOut,
)
